...
@Gtk.Template(resource_path = '/com/wittara/studio/database_add_duckdb_view.ui')
class DatabaseAddDuckDBView(Adw.PreferencesPage):

    __gtype_name__ = 'DatabaseAddDuckDBView'
    ...
    def on_connect(self) -> None:
        ...
        def do_connect() -> None:
            ...
            success, message = ConnectionManager.check_connection('duckdb', config)
    ...
    def _on_database_clicked(self,
        ...
        FILTER_SQLITE.set_name(_('DuckDB Files'))
        FILTER_SQLITE.add_pattern('*.duckdb')
        FILTER_SQLITE.add_pattern('*.ddb')
        FILTER_SQLITE.add_pattern('*.db')
        FILTER_SQLITE.add_mime_type('application/vnd.duckdb3')
