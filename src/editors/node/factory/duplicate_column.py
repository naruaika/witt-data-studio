...
class NodeDuplicateColumn(NodeTemplate):

    ndname = _('Duplicate Column')
    ...
    def do_process(self,
        ...
        if self.frame.data['columns']:
            ...
            new_column = unique_name(column, columns, separator = '_')
            table = table.with_columns(col(column).alias(new_column))
