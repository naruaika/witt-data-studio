...
class NodeExtractNameOfMonth(NodeTemplate):

    ndname = _('Extract Name of Month')

    action = 'extract-name-of-month'
    ...
    def new(x:   int = 0,
        ...
        """"""
        self = NodeExtractNameOfMonth(x, y)
