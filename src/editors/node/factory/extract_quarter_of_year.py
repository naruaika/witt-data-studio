...
class NodeExtractQuarterOfYear(NodeTemplate):

    ndname = _('Extract Quarter of Year')

    action = 'extract-quarter-of-year'
    ...
    def new(x:   int = 0,
        ...
        """"""
        self = NodeExtractQuarterOfYear(x, y)
    ...
    def do_process(self,
        ...
        if self.frame.data['columns']:
            ...
            table = table.with_columns(col(column).dt.quarter())
    ...
    def _refresh_column(self) -> None:
        ...
        table_columns = table.select(cs.date() | cs.datetime()) \
                             .collect_schema() \
                             .names()
