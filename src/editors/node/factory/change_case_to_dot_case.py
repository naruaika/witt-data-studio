...
class NodeChangeCaseToDotCase(NodeTemplate):

    ndname = _('Change Case to Dot Case')

    action = 'change-case-to-dot-case'
    ...
    def new(x:   int = 0,
        ...
        """"""
        self = NodeChangeCaseToDotCase(x, y)
    ...
    def do_process(self,
        ...
        if self.frame.data['columns']:
            ...
            expr = col(column).str.replace_all(r'([a-z])([A-Z])', r'${1}.${2}') \
