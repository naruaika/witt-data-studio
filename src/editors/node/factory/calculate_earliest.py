...
class NodeCalculateEarliest(NodeTemplate):

    ndname = _('Calculate Earliest')

    action = 'calculate-earliest'
    ...
    def new(x:   int = 0,
        ...
        """"""
        self = NodeCalculateEarliest(x, y)
    ...
    def _refresh_column(self) -> None:
        ...
        selectors = cs.date() | cs.time() | cs.datetime()
        table_columns = table.select(selectors) \
                             .collect_schema() \
                             .names()
