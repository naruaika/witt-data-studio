...
class NodeExtractDayOfWeek(NodeTemplate):

    ndname = _('Extract Day of Week')

    action = 'extract-day-of-week'
    ...
    def do_process(self,
        ...
        if self.frame.data['columns']:
            ...
            table = table.with_columns(col(column).dt.weekday())
