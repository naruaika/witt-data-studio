...
class NodeExtractStartOfMonth(NodeTemplate):

    ndname = _('Extract Start of Month')

    action = 'extract-start-of-month'
    ...
    def new(x:   int = 0,
        ...
        """"""
        self = NodeExtractStartOfMonth(x, y)
    ...
    def do_process(self,
        ...
        if self.frame.data['columns']:
            ...
            expr = col(column).dt.truncate('1mo')
