...
class NodeExtractSecond(NodeTemplate):

    ndname = _('Extract Second')

    action = 'extract-second'
    ...
    def do_process(self,
        ...
        if self.frame.data['columns']:
            ...
            table = table.with_columns(col(column).dt.second())
