# change_case_to_constant_case.py
#
...
class NodeChangeCaseToConstantCase(NodeTemplate):

    ndname = _('Change Case to Constant Case')

    action = 'change-case-to-constant-case'
    ...
    def new(x:   int = 0,
        ...
        """"""
        self = NodeChangeCaseToConstantCase(x, y)
    ...
    def do_process(self,
        ...
        if self.frame.data['columns']:
            ...
            expr = col(column).str.replace_all(r'([a-z])([A-Z])', r'${1}_${2}') \
