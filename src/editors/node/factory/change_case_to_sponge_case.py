...
class NodeChangeCaseToSpongeCase(NodeTemplate):

    ndname = _('Change Case to Sponge Case')

    action = 'change-case-to-sponge-case'
    ...
    def new(x:   int = 0,
        ...
        """"""
        self = NodeChangeCaseToSpongeCase(x, y)
    ...
    def do_process(self,
        ...
        if self.frame.data['columns']:
            ...
            expr = col(column).strx.to_sponge_case()
