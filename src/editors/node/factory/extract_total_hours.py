...
class NodeExtractTotalHours(NodeTemplate):

    ndname = _('Extract Total Hours')

    action = 'extract-total-hours'
    ...
    def new(x:   int = 0,
        ...
        """"""
        self = NodeExtractTotalHours(x, y)
    ...
    def do_process(self,
        ...
        if self.frame.data['columns']:
            ...
            expr = col(column).dt.total_hours(fractional = True)
