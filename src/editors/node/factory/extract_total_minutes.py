...
class NodeExtractTotalMinutes(NodeTemplate):

    ndname = _('Extract Total Minutes')

    action = 'extract-total-minutes'
    ...
    def new(x:   int = 0,
        ...
        """"""
        self = NodeExtractTotalMinutes(x, y)
    ...
    def do_process(self,
        ...
        if self.frame.data['columns']:
            ...
            expr = col(column).dt.total_minutes(fractional = True)
