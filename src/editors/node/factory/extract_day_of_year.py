...
class NodeExtractDayOfYear(NodeTemplate):

    ndname = _('Extract Day of Year')

    action = 'extract-day-of-year'
    ...
    def do_process(self,
        ...
        if self.frame.data['columns']:
            ...
            table = table.with_columns(col(column).dt.ordinal_day())
