...
class NodeExtractWeekOfMonth(NodeTemplate):

    ndname = _('Extract Week of Month')

    action = 'extract-week-of-month'
    ...
    def new(x:   int = 0,
        ...
        """"""
        self = NodeExtractWeekOfMonth(x, y)
