# extract_text_between_delimiters.py
#
...
class NodeExtractTextBetweenDelimiters(NodeTemplate):
    ...
    def _add_start(self) -> None:
        ...
        def do_link(pair_socket:  NodeSocket,
            ...
            self.frame.data['start.bak'] = content.get_data()
        ...
        def do_unlink(socket: NodeSocket) -> None:
            ...
            if 'start.bak' in self.frame.data:
                content.set_data(self.frame.data['start.bak'])
    ...
    def _add_end(self) -> None:
        ...
        def do_link(pair_socket:  NodeSocket,
            ...
            self.frame.data['end.bak'] = content.get_data()
        ...
        def do_unlink(socket: NodeSocket) -> None:
            ...
            if 'end.bak' in self.frame.data:
                content.set_data(self.frame.data['end.bak'])
