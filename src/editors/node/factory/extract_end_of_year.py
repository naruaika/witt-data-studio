...
class NodeExtractEndOfYear(NodeTemplate):

    ndname = _('Extract End of Year')

    action = 'extract-end-of-year'
    ...
    def do_process(self,
        ...
        if self.frame.data['columns']:
            ...
            expr = date(col(column).dt.year(), 12, 31)
