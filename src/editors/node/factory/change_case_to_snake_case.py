...
class NodeChangeCaseToSnakeCase(NodeTemplate):

    ndname = _('Change Case to Snake Case')

    action = 'change-case-to-snake-case'
    ...
    def new(x:   int = 0,
        ...
        """"""
        self = NodeChangeCaseToSnakeCase(x, y)
