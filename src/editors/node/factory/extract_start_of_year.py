...
class NodeExtractStartOfYear(NodeTemplate):

    ndname = _('Extract Start of Year')

    action = 'extract-start-of-year'
    ...
    def new(x:   int = 0,
        ...
        """"""
        self = NodeExtractStartOfYear(x, y)
    ...
    def do_process(self,
        ...
        if self.frame.data['columns']:
            ...
            expr = date(col(column).dt.year(), 1, 1)
