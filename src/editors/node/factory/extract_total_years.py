...
class NodeExtractTotalYears(NodeTemplate):

    ndname = _('Extract Total Years')

    action = 'extract-total-years'
    ...
    def new(x:   int = 0,
        ...
        """"""
        self = NodeExtractTotalYears(x, y)
    ...
    def do_process(self,
        ...
        if self.frame.data['columns']:
            ...
            expr = col(column).dt.total_days(fractional = True) / 365.25
