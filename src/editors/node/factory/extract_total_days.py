...
class NodeExtractTotalDays(NodeTemplate):

    ndname = _('Extract Total Days')

    action = 'extract-total-days'
    ...
    def do_process(self,
        ...
        if self.frame.data['columns']:
            ...
            expr = col(column).dt.total_days(fractional = True)
