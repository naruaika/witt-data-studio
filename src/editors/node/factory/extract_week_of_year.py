...
class NodeExtractWeekOfYear(NodeTemplate):

    ndname = _('Extract Week of Year')

    action = 'extract-week-of-year'
    ...
    def new(x:   int = 0,
        ...
        """"""
        self = NodeExtractWeekOfYear(x, y)
    ...
    def do_process(self,
        ...
        if self.frame.data['columns']:
            ...
            table = table.with_columns(col(column).dt.week())
