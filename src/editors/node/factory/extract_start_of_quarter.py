...
class NodeExtractStartOfQuarter(NodeTemplate):

    ndname = _('Extract Start of Quarter')

    action = 'extract-start-of-quarter'
    ...
    def new(x:   int = 0,
        ...
        """"""
        self = NodeExtractStartOfQuarter(x, y)
    ...
    def do_process(self,
        ...
        if self.frame.data['columns']:
            ...
            expr = col(column).dt.truncate('1q')
