# change_case_to_sentence_case.py
#
...
class NodeChangeCaseToSentenceCase(NodeTemplate):

    ndname = _('Change Case to Sentence Case')

    action = 'change-case-to-sentence-case'
    ...
    def new(x:   int = 0,
        ...
        """"""
        self = NodeChangeCaseToSentenceCase(x, y)
    ...
    def do_process(self,
        ...
        if self.frame.data['columns']:
            ...
            expr = col(column).strx.to_sentence_case()
