...
class NodeExtractStartOfWeek(NodeTemplate):

    ndname = _('Extract Start of Week')

    action = 'extract-start-of-week'
    ...
    def new(x:   int = 0,
        ...
        """"""
        self = NodeExtractStartOfWeek(x, y)
    ...
    def do_process(self,
        ...
        if self.frame.data['columns']:
            ...
            expr = col(column).dt.truncate('1w')
