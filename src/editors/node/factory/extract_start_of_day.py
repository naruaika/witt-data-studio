...
class NodeExtractStartOfDay(NodeTemplate):

    ndname = _('Extract Start of Day')

    action = 'extract-start-of-day'
    ...
    def new(x:   int = 0,
        ...
        """"""
        self = NodeExtractStartOfDay(x, y)
    ...
    def do_process(self,
        ...
        if self.frame.data['columns']:
            ...
            expr = col(column).dt.truncate('1d')
