...
class NodeExtractEndOfQuarter(NodeTemplate):

    ndname = _('Extract End of Quarter')

    action = 'extract-end-of-quarter'
    ...
    def new(x:   int = 0,
        ...
        """"""
        self = NodeExtractEndOfQuarter(x, y)
