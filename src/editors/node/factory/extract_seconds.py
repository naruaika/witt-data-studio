...
class NodeExtractSeconds(NodeTemplate):

    ndname = _('Extract Seconds')

    action = 'extract-seconds'
    ...
    def do_process(self,
        ...
        if self.frame.data['columns']:
            ...
            expr = col(column).dt.total_seconds(fractional = False)
