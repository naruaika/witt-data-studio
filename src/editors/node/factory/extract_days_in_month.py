...
class NodeExtractDaysInMonth(NodeTemplate):

    ndname = _('Extract Days in Month')

    action = 'extract-days-in-month'
    ...
    def new(x:   int = 0,
        ...
        """"""
        self = NodeExtractDaysInMonth(x, y)
    ...
    def do_process(self,
        ...
        if self.frame.data['columns']:
            ...
            expr = col(column).dt.days_in_month()
