...
class NodeChangeCaseToKebabCase(NodeTemplate):

    ndname = _('Change Case to Kebab Case')

    action = 'change-case-to-kebab-case'
    ...
    def new(x:   int = 0,
        ...
        """"""
        self = NodeChangeCaseToKebabCase(x, y)
    ...
    def do_process(self,
        ...
        if self.frame.data['columns']:
            ...
            expr = col(column).str.replace_all('([a-z])([A-Z])', r'${1}-${2}') \
