...
@Gtk.Template(resource_path = '/com/wittara/studio/ui/database_import/template.ui')
class DatabaseImportWindow(Adw.Window):
    ...
    def _setup_connection_list_factory(self,
        ...
        def on_rmb_click(gesture: Gtk.GestureClick,
            ...
            menu = Gio.Menu.new()
            menu.append(_('_Copy'),      f"app.copy-to-clipboard('{item_data.cname}')")
    ...
    def _on_add_new_action(self,
        ...
        from ..database_add.widget import DatabaseAddWindow
    ...
    def _run_query(self,
        ...
        def do_run() -> None:
            ...
            from ...backend.database import Database
            output, log_info = Database.execute(dialect   = citem.dialect,
                                                config    = config,
                                                query     = query,
                                                n_samples = 1_000)
    ...
    def _on_import_button_clicked(self,
        ...
        from ...editors.node.factory import NodeReadDatabase
