...
@Gtk.Template(resource_path = '/com/wittara/studio/ui/file_import/template.ui')
...
#           return
    ...
    def _get_current_settings(self,
        ...
        match self.file_format:
            case 'csv' | 'tsv' | 'txt':
                from .view_csv import SEPARATOR_OPTS
                from .view_csv import QUOTE_CHAR_OPTS
                from .view_csv import DECIMAL_COMMA_OPTS
...
#               kwargs['df_names'] = self.conf_widgets['df_names'].get_selected() or None
    ...
    def _on_import_button_clicked(self,
        ...
        from ...editors.node.factory import NodeReadFile
        from ...editors.node.factory import NodeSheet
    ...
    def _setup_default_page(self) -> None:
        """"""
        dataframe = File.read(file_path  = self.file_path,
    ...
    def _setup_settings_box(self) -> None:
        ...
        match self.file_format:
            case 'csv' | 'tsv' | 'txt':
                from .view_csv import FileImportCSVView
            ...
            case 'parquet':
                from .view_parquet import FileImportParquetView
    ...
    def _setup_navigator_page(self) -> None:
        """"""
        try:
            reader = File.read(self.file_path)
        except Exception:
            self._setup_error_page()
            return
