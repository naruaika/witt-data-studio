...
@Gtk.Template(resource_path = '/com/wittara/studio/ui/window/template.ui')
class Window(Adw.ApplicationWindow):
    ...
    def __init__(self, **kwargs) -> None:
        ...
        self.node_editor: NodeEditor = None
    ...
    def _setup_uinterfaces(self) -> None:
        ...
        from ..command_palette.widget import CommandPalette
        self.CommandPalette = CommandPalette()
        self.Container.add_overlay(self.CommandPalette)

        if self.file_path:
            self.StatusBar.set_file_saved(True)
