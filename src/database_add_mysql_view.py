...
@Gtk.Template(resource_path = '/com/wittara/studio/database_add_mysql_view.ui')
class DatabaseAddMySQLView(Adw.PreferencesPage):

    __gtype_name__ = 'DatabaseAddMySQLView'
    ...
    def on_connect(self) -> None:
        ...
        def do_connect() -> None:
            ...
            success, message = ConnectionManager.check_connection('mysql', config)
