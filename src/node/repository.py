...
class NodeSplitColumnByNoCharacters(NodeTemplate):

    ndname = _('Split Column by No. Characters')

    action = 'split-column-by-no-characters'
    ...
    def new(x:   int = 0,
        ...
        """"""
        self = NodeSplitColumnByNoCharacters(x, y)
